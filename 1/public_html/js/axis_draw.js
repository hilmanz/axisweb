...
function popupUserConversation(a){
	...
	$.each(a, function(x, item) {
		...
		str+='<a class="facebook" href="#" onclick="shareFB(\''+a[x].nickname+'\',\''+fb_img+'\',\''+a[x].posting+'\')">&nbsp;</a>';
		str+='<a class="twitter" href="https://twitter.com/intent/tweet?button_hashtag=AXISbarokah&text='+a[x].posting+'" data-size="large" data-related="AxisBarokah">&nbsp;</a>';
		str+='</div>';
		str+='</div><!-- end .row -->';
	});
	return str;
